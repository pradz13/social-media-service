...
CREATE TABLE RECOMMENDATION(
    ...
    PRIMARY KEY(id),
    CONSTRAINT FK_USER_WITH_RECOMMENDATION_USER FOREIGN KEY (user_id) REFERENCES USER_PROFILE(id),
    CONSTRAINT FK_USER_WITH_RECOMMENDATION_RECIPIENT FOREIGN KEY (recipient_id) REFERENCES USER_PROFILE(id)
);
